...
1. Excel Online:
   ...
   - Table entry (row-by-row, horizontal):
     ...
     - To enter a row:
      ...
      - Example Format: `"action": [{"type": "input", "id": <name_box_id>, "value": "A1"},{"type": "shortcut_combo", "value": "enter"},{"type": "canvas_input", "value": "<col1>"},{"type": "shortcut_combo", "value": "tab"},{"type": "canvas_input", "value": "<col2>"},{"type": "shortcut_combo", "value": "tab"}]`
...
3. Outlook (outlook.live.com / outlook.office.com):
   - Single recipient:
     ...
     - Format: `"action": [{"type": "input", "id": <to_element>, "value": "<email>"},{"type": "input", "id": <subject_element>, "value": "<subject>"},{"type": "click", "id": <body_element>},{"type": "canvas_input", "value": "<body_text>"}]`
   - Multiple recipients:
